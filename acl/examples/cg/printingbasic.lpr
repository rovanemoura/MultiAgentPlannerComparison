...
(define-project :name :basic-printing-example
  :modules (list (make-instance 'module :name "printingbasic"))
  :projects nil
  :libraries nil
  ...
  :compilation-unit t
  :verbose nil
  :runtime-modules '(:cg-dde-utils :cg.base :cg.printing
                     :cg.scaling-stream)
  ...
  :on-initialization 'run-basic-printing-example
