...
(define-project :name :palettes-example
  :modules (list (make-instance 'module :name "palette"))
  :projects nil
  :libraries nil
  ...
  :compilation-unit t
  :verbose nil
  :runtime-modules '(:cg-dde-utils :cg.base :cg.palette)
  ...
  :on-initialization 'run-palettes-example
