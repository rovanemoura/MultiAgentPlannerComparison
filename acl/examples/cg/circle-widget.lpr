...
(define-project :name :circle-widget-example
  :modules (list (make-instance 'module :name "circle-widget"))
  :projects nil
  :libraries nil
  ...
  :compilation-unit t
  :verbose nil
  :runtime-modules '(:cg-dde-utils :cg.base :cg.curve :cg.dialog-item
                     :cg.get-position :cg.lisp-widget)
  ...
  :on-initialization 'run-circle-widget-example
