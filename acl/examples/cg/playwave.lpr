...
(define-project :name :play-wave-example
  :modules (list (make-instance 'module :name "playwave"))
  :projects nil
  :libraries nil
  ...
  :compilation-unit t
  :verbose nil
  :runtime-modules '(:cg-dde-utils :cg.base :cg.mci)
  ...
  :on-initialization 'run-play-wave-example
