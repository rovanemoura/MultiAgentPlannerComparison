...
(define-project :name :carets-example
  :modules (list (make-instance 'module :name "carets"))
  :projects nil
  :libraries nil
  ...
  :compilation-unit t
  :verbose nil
  :runtime-modules '(:cg-dde-utils :cg.base :cg.caret :cg.pixmap)
  ...
  :on-initialization 'run-carets-example
