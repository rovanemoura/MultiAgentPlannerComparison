...
(define-project :name :clipboard-example
  :modules (list (make-instance 'module :name "clipbord"))
  :projects nil
  :libraries nil
  ...
  :compilation-unit t
  :verbose nil
  :runtime-modules '(:cg-dde-utils :cg.base :cg.clipboard
                     :cg.clipboard-stack :cg.clipboard.pixmap
                     :cg.keyboard-shortcuts :cg.menu :cg.pixmap
                     :cg.wrap-string)
  :splash-file-module (make-instance 'build-module :name "")
  :icon-file-module (make-instance 'build-module :name "")
  :include-flags '(:debugger)
  ...
  :on-initialization 'run-clipboard-example
