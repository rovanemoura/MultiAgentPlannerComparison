...
(define-project :name :simple-grid-example
  :modules (list (make-instance 'module :name "simple-grid"))
  :projects nil
  :libraries nil
  ...
  :runtime-modules '(:cg-dde-utils :cg.base :cg.caret :cg.clipboard
                     ...
                     :cg.static-text :cg.text-edit-pane
  ...
  :on-initialization 'run-color-grid-example
