...
cp ../benchmarks/unfactored/$1/$2/${domain_name}.pddl ~/TAPLAN/input_folder/
cp ../benchmarks/unfactored/$1/$2/${problem_name}.pddl ~/TAPLAN/input_folder/
...
python3 ma-to-pddl_TA.py ~/TAPLAN/input_folder $domain_name $problem_name ~/TAPLAN/output_folder
