(define (domain floods)
  ...
  (:predicates (cdm_at ?c - cdm ?a - area) (box_at_cdm ?b - box ?c - cdm)
   ...
   (in_range ?a1 - area ?a2 - area) (anon-at-usv8 ?a - area)
   (anon-store_of-usv8 ?s - store) (anon-have_picture-usv8 ?d - disaster)
   (anon-box_at-usv8 ?b - box ?r - ugv) (anon-have_water_sample-usv8 ?a - area))
