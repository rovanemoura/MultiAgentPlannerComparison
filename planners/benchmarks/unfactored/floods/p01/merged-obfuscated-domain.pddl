(define (domain floods)
  ...
  (:predicates (anon-have_water_sample-ugv3 ?r - usv ?a - area)
   ...
   (anon-box_at-uav2 ?b - box ?r - ugv) (anon-have_picture-uav2 ?d - disaster)
   (anon-store_of-uav2 ?s - store) (anon-at-uav2 ?a - area)
   ...
   (anon-at-ugv1 ?a - area) (anon-have_water_sample-usv3 ?a - area)
