(define (problem obfuscated-codmap-problem-usv4) (:domain floods)
  (:objects box10 box9 box8 box7 box6 box5 box4 box3 box2 box1 - box
             ...
             cdm6 cdm5 cdm4 cdm3 cdm2 cdm1 - cdm
            )
  (:init
       (anon-at-usv8 area33)
       ...
       (anon-at-usv10 area41)
       (anon-store_of-usv10 usv10store)
       ...
       (anon-at-usv6 area21)
       (anon-store_of-usv11 usv11store)
       (anon-at-usv11 area53)
       (anon-store_of-ugv7 ugv7store)
       (anon-at-ugv7 area33)
       (anon-store_of-ugv11 ugv11store)
       (anon-at-ugv11 area53)
       (anon-at-uav10 area41))
  (:goal (and 
