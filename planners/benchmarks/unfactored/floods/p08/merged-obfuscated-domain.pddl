(define (domain floods)
  ...
  (:predicates (anon-have_water_sample-usv3 ?a - area)
   (anon-box_at-usv3 ?b - box ?r - ugv) (anon-have_picture-usv3 ?d - disaster)
   (anon-store_of-usv3 ?s - store) (anon-at-usv3 ?a - area)
   ...
   (anon-have_water_sample-uav9 ?r - usv ?a - area)
   ...
   (anon-at-usv5 ?a - area) (anon-store_of-usv5 ?s - store)
   (anon-have_picture-usv5 ?d - disaster) (anon-box_at-usv5 ?b - box ?r - ugv)
   (anon-have_water_sample-usv5 ?a - area))
