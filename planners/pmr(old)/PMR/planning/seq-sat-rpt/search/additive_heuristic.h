...
public:
    ...
    // Vidal: set as public for caching of best supporters
    // used only in RPTs, I should use the cached ff version and move this back to protected
    void setup_exploration_queue();
    void setup_exploration_queue_state(const State &state);
    void relaxed_exploration(bool level_off = false); // Vidal: added level_off
