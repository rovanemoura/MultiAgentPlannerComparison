(define (problem ipc3-pfile18) (:domain rover)
  (:objects objective0 objective1 objective2 objective3 objective4 objective5 objective6 - objective
             camera3 camera4 - camera
