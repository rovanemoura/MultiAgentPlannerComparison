...
(define (problem p005-ag2-sequential)
  ...
  (:init
    ...
    (at-player player-01 pos-09-02)
    (at-player player-02 pos-04-03)
    (at-stone stone-01 pos-08-03)
    (at-stone stone-02 pos-08-04)
    (at-stone stone-03 pos-04-06)
    (at-stone stone-04 pos-06-06)
    (at-stone stone-05 pos-08-06)
    (clear pos-01-01)
    (clear pos-01-02)
    (clear pos-01-03)
    (clear pos-01-04)
