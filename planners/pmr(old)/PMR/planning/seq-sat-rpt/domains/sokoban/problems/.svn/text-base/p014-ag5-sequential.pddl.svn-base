...
(define (problem p014-ag5-sequential)
  ...
  (:init
    ...
    (at-goal stone-02)
    (at-player player-01 pos-11-08)
    (at-player player-02 pos-03-09)
    (at-player player-03 pos-04-09)
    (at-player player-04 pos-05-09)
    (at-player player-05 pos-06-09)
    (at-stone stone-01 pos-04-03)
    (at-stone stone-02 pos-05-04)
    (at-stone stone-03 pos-04-06)
    (at-stone stone-04 pos-08-09)
    (at-stone stone-05 pos-10-09)
    (clear pos-01-01)
    (clear pos-01-02)
    (clear pos-01-03)
    (clear pos-01-04)
