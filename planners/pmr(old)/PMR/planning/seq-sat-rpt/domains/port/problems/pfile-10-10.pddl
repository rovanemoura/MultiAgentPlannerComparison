(define (problem nil) (:domain port)
  ...
  (:goal (and 
       ...
       (on-ship crate6 pallet15 ship1)
       (on-ship crate5 pallet38 ship5)
       (on-ship crate4 crate2 ship5)
       (on-ship crate3 pallet21 ship2)
       (on-ship crate2 pallet43 ship5)
       (on-ship crate1 pallet17 ship1)
