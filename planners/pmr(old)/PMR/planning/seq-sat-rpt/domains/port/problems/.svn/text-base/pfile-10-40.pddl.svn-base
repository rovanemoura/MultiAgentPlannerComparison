(define (problem nil) (:domain port)
  ...
  (:init
       ...
       (next level0 level1))
  (:goal (and 
       (on-ship crate39 pallet110 ship8)
       (on-ship crate38 pallet68 ship4)
       (on-ship crate37 pallet39 ship1)
       (on-ship crate36 pallet117 ship9)
       (on-ship crate35 crate20 ship4)
       (on-ship crate34 pallet29 ship1)
       (on-ship crate33 pallet27 ship0)
       (on-ship crate32 pallet63 ship4)
       (on-ship crate31 pallet90 ship6)
       (on-ship crate30 pallet72 ship4)
       (on-ship crate29 crate13 ship0)
       (on-ship crate28 pallet59 ship3)
       (on-ship crate27 pallet20 ship0)
       (on-ship crate26 pallet32 ship1)
       (on-ship crate25 pallet75 ship5)
       (on-ship crate24 crate12 ship7)
       (on-ship crate23 pallet66 ship4)
       (on-ship crate22 pallet36 ship1)
       (on-ship crate21 pallet95 ship7)
       (on-ship crate20 pallet71 ship4)
       (on-ship crate19 pallet34 ship1)
       (on-ship crate18 pallet101 ship7)
       (on-ship crate17 pallet64 ship4)
       (on-ship crate16 pallet119 ship9)
       (on-ship crate15 crate5 ship9)
       (on-ship crate14 pallet123 ship9)
       (on-ship crate13 pallet22 ship0)
       (on-ship crate12 pallet97 ship7)
       (on-ship crate11 pallet115 ship8)
       (on-ship crate10 pallet53 ship3)
       (on-ship crate9 pallet42 ship2)
       (on-ship crate8 pallet79 ship5)
       (on-ship crate7 pallet89 ship6)
       (on-ship crate6 crate3 ship6)
       (on-ship crate5 pallet127 ship9)
       (on-ship crate4 pallet61 ship3)
       (on-ship crate3 pallet84 ship6)
       (on-ship crate2 pallet120 ship9)
       (on-ship crate1 pallet43 ship2)
       (on-ship crate0 pallet104 ship7))))