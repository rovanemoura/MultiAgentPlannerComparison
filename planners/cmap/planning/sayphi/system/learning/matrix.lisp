...
(defun nwarshall-boolean (array)
  "Implements in-place (destructive) Warshall's algorithm for the transitive closure. Do not forget to make a copy (copy-array) of the array before. Not very efficient. Assumes square boolean matrix"
  (declare (type (array boolean 2) array))
...
;; Efficient implementation of Warshall algorithm for in place computing the transitive clousure of a matrix. It does not work on some Lisps
(defun nwarshall-bit (a)
  "Implements Warshall's algorithm for the transitive closure. Transitively closes the square bit matrix a in place. [Baase, p.223]"
