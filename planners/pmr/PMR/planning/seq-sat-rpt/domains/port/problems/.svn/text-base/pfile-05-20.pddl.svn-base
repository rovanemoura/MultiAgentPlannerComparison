(define (problem nil) (:domain port)
  ...
  (:init
       ...
       (next level0 level1))
  (:goal (and 
       (on-ship crate19 crate6 ship0)
       (on-ship crate18 pallet10 ship0)
       (on-ship crate17 pallet13 ship0)
       (on-ship crate16 crate7 ship4)
       (on-ship crate15 crate5 ship3)
       (on-ship crate14 pallet28 ship4)
       (on-ship crate13 crate3 ship1)
       (on-ship crate12 crate9 ship2)
       (on-ship crate11 pallet19 ship2)
       (on-ship crate10 pallet17 ship1)
       (on-ship crate9 crate2 ship2)
       (on-ship crate8 crate4 ship1)
       (on-ship crate7 crate1 ship4)
       (on-ship crate6 pallet11 ship0)
       (on-ship crate5 crate0 ship3)
       (on-ship crate4 pallet15 ship1)
       (on-ship crate3 pallet16 ship1)
       (on-ship crate2 pallet21 ship2)
       (on-ship crate1 pallet29 ship4)
