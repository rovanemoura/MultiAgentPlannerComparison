(define (problem nil) (:domain port)
  ...
  (:init
       ...
       (next level0 level1))
  (:goal (and 
       (on-ship crate9 pallet45 ship6)
       (on-ship crate8 pallet92 ship14)
       (on-ship crate7 crate6 ship13)
       (on-ship crate6 crate5 ship13)
       (on-ship crate5 pallet91 ship13)
       (on-ship crate4 pallet32 ship4)
       (on-ship crate3 pallet46 ship6)
       (on-ship crate2 pallet11 ship0)
       (on-ship crate1 pallet90 ship13)
       (on-ship crate0 pallet82 ship12))))