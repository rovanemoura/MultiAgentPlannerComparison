(define (problem nil) (:domain port)
  ...
  (:init
       ...
       (next level0 level1))
  (:goal (and 
       (on-ship crate9 pallet12 ship1)
       (on-ship crate8 pallet17 ship3)
       (on-ship crate7 pallet9 ship1)
       (on-ship crate6 pallet6 ship0)
       (on-ship crate5 pallet11 ship1)
       (on-ship crate4 pallet15 ship2)
       (on-ship crate3 pallet22 ship4)
       (on-ship crate2 pallet7 ship0)
       (on-ship crate1 pallet16 ship2)
       (on-ship crate0 pallet10 ship1))))