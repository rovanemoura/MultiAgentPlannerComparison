...
#define EXECUTION_INTERMEDIATE_REACHAB_INFORM  3
...
//MODIFICHE COCCOLI
#define MAX_VECTOR_INC 100 /* Numero massimo degli elementi degli array utilizzati nelle funzioni di rimozione delle inconsistenze*/
...
typedef struct _GPG
  ...
  /* ADAPT */
    ...
    int print_xml_solution; /* if TRUE print the output plan in XML format; if ==1 add xml code to the solution as a comment */
