...
(:objects
rover0store - store
objective3 objective2 objective1 objective0 - objective
low_res colour high_res - mode
rover0 - rover
camera4 camera5 camera2 camera3 camera0 camera1 - camera
general - lander
waypoint4 waypoint5 waypoint6 waypoint0 waypoint1 waypoint2 waypoint3 - waypoint
)
(:init
